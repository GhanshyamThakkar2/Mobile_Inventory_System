...
Public Class Sales_detail_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project.Sales_detail_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSales_detail_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sales_detail_rpt = New Sales_detail_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
