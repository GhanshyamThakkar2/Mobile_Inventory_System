...
Public Class Invoice
    ...
    Private Sub load_invoice_data()
        ...
        Try
            ...
            ds = d.loaddata("Select IMEI_No,Product_Name,Rate,Quantity,CGST,SGST,Taxable_amt from Sales_Detail where Invoice_No = '" & txt_invoice.Text & "'")
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        txt_imei.Text = selected.Cells(0).Value.ToString()
        txt_pname.Text = selected.Cells(1).Value.ToString()
        txt_unit_price.Text = selected.Cells(2).Value.ToString()
        txt_qty.Text = selected.Cells(3).Value.ToString()
        txt_cgst_per.Text = selected.Cells(4).Value.ToString()
        txt_sgst_per.Text = selected.Cells(5).Value.ToString()
        txt_totamt.Text = selected.Cells(6).Value.ToString()
                                        ...
                                        If txt_cgst_per.Text <> "" Then
                                            ...
                                            If txt_sgst_per.Text <> "" Then
                                                ...
                                                If txt_totamt.Text <> "" Then
                                                    ...
                                                    d.modifyData("Insert into Sales_Detail(Invoice_No,IMEI_No,Product_Name,Quantity,Rate,CGST,SGST,Taxable_amt) values('" & txt_invoice.Text & "','" & txt_imei.Text & "','" & txt_pname.Text & "','" & txt_qty.Text & "'," & txt_unit_price.Text & "," & txt_cgst_per.Text & "," & txt_sgst_per.Text & "," & txt_totamt.Text & ")")
    ...
    Private Sub Btn_print_Click(sender As Object, e As EventArgs) Handles Btn_print.Click
        ...
        If DataGridView1.Rows.Count > 0 Then
            ...
            ds = d.loaddata("select Invoice_no,Bill_date,Customer_Name,Customer_Mobile_no,Customer_address,Discount,Round_off,Total_gst,Total_Amount,Tax_amt from Sales_Summary where Invoice_no = '" & txt_invoice.Text & "'")
