...
Public Class Add_Supplier
    ...
    Private Sub txt_sname_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_st.KeyDown, txt_sname.KeyDown, txt_Pd.KeyDown, txt_Cno.KeyDown, txt_city.KeyDown, txt_bank_name.KeyDown, txt_add.KeyDown
    ...
    Private Sub txt_sname_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_st.KeyPress, txt_sname.KeyPress, txt_city.KeyPress, txt_bank_name.KeyPress
